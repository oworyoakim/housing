        ...
        <div class="col-12">
            <div class="card mt-2">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea wire:model.lazy="property.description"
                                          ...
                                          rows="5"></textarea>
                                @error('property.description')<span
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Country</label>
                                <select wire:model="property.country"
                                        class="form-control select2 @error('property.country') is-invalid @enderror"
                                        style="width: 100%;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>City</label>
                                <select wire:model="property.city"
                                        class="form-control select2 @error('property.city') is-invalid @enderror"
                                        style="width: 100%;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            @if($property->featured_image)
                                <img src="{{$property->featured_image->path}}" class="img-fluid" height="100"
                                     width="100">
                            @endif
                        </div>
                        <div class="col-4">
                ...
                <div class="card-footer">
                    <button type="button" wire:click.prevent="updateProperty" class="btn btn-warning btn-block">
