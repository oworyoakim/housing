<div  class="mt-2">
    @section('title', "Update Room/Service Info")
    <div class="card">
        <div class="card-header bg-gradient-secondary">
            <h3 class="card-title">Update Room/Service Info</h3>
            <div class="card-tools">
                <a href="{{route('view-property', ['property_id' => $room->property_id])}}" class="btn btn-dark btn-sm"><i class="fa fa-backward"></i> Back To Property</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
        ...
        <div class="card-footer">
            <button type="button" wire:click.prevent="updateRoomOrService" class="btn btn-warning btn-block">
